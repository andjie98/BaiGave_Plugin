...
def schem(level,chunks,cached,filename="schem",position=(0,0,0)):
    ...
    if not cached:
        ...
        IDCachePath = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/schemcache/id_map.pkl"
...
def schem_chunk(level,chunks,x_list,filename="schem",position=(0,0,0)):
    ...
    IDCachePath = os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/schemcache/chunk{}.pkl".format(current_frame)
